...
This repository allows you to design your own lattice models with your desired transport behavior and to reproduce the examples discussed in our publication: \
...
dataset_merge.ipynb: Merge the individual files created by dataset_generation_amplifier.py into a single file. Furthermore, this notebook provides plotting routines for analyzing the lattices' properties.

For the symbolic regression, we use AIFeynman2. See its [GitHub repository](https://github.com/SJ001/AI-Feynman) one more details how to use AIFeynman.
